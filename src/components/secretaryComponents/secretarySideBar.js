...
const SideBar = React.memo(({ isOpen, setIsOpen }) => {
  ...
  const navItems = useMemo(
    () => [
      { icon: BsFillBoxFill, label: "Dashboard", href: "/secretaryDashboard" },
    ...
    <AuthWrapper>
        ...
        >
            ...
            <img
                ...
                alt="profile"
                onError={(e) => (e.target.src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvpeEqDZn3rbSqRRIhJs35bhFu-HQt5U0T74L_Xhzdaq6VKLkZlNHSvnxxBLDuhLvSPVM&usqp=CAU")}
                className={`${
